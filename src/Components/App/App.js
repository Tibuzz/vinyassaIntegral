...
import { Vinyassa } from '../vinyassa/Vinyassa';
  ...
  return (
      ...
      <div className='App'>
        <div className='content'>
          ...
          <PhotosRoberto />
          <Agenda />
          <CommentsPage comments={comments} addComment={addComment} />
          <Contact />
